...
public class UniqueLocationValidator implements ConstraintValidator<UniqueLocation, Object> {
	...
	/*
	 * @Override public boolean isValid(Object object, ConstraintValidatorContext
	 * context) { Object postalCodeVal = new
	 * BeanWrapperImpl(object).getPropertyValue(postalCode); Object streetNumberVal
	 * = new BeanWrapperImpl(object).getPropertyValue(streetNumber); List<Location>
	 * locationByPostalCodeAndStreetNumber =
	 * service.getLocationByPostalCodeAndStreetNumber(postalCodeVal.toString(),
	 * streetNumberVal.toString()); return
	 * locationByPostalCodeAndStreetNumber.isEmpty();
	 * 
	 * //return true; }
	 */
	@Override
	public boolean isValid(Object object, ConstraintValidatorContext context) {
		...
		if (object instanceof EditLocationDTO) {
			idVal = new BeanWrapperImpl(object).getPropertyValue(id);
			/* in edit mode */
